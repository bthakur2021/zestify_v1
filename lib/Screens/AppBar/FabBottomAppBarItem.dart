...
class FabBottomAppBarItem {
  FabBottomAppBarItem({this.key, this.selectedAssetImage,this.unselectedAssetImage, this.text});
  GlobalKey key;
...
class FabBottomAppBar extends StatefulWidget {
  ...
  FabBottomAppBar({
    ...
    assert(this.items.length == 2 || this.items.length == 4 || this.items.length == 5);
  }
